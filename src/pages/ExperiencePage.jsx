...
<div className='experience-page w-100 d-flex align-items-center overflow-hidden'>
    <Container>
        <Row className='header-box'>
            ...
            <h4 className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>PT Hero Supermarket tbk</h4>
        ...
        <Row className='header-box2 pt-5'>
            ...
            <h4 className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>PT Kalbe Farma tbk</h4>
            <p className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>
